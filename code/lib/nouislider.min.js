!(function (t, e) {
  ...
  (ot.PipsMode = void 0),
    ((H = ot.PipsMode || (ot.PipsMode = {})).Range =
      "range"),
    (H.Steps = "steps"),
  ...
  var u =
    ...
    (t.prototype.hasNoSize = function () {
      return (
        this.xVal[0] === this.xVal[this.xVal.length - 1]
      );
    }),
    ...
    (t.prototype.handleEntryPoint = function (t, e) {
      t =
        "min" === t ? 0 : "max" === t ? 100 : parseFloat(t);
      if (!i(t) || !i(e[0]))
        throw new Error(
  ...
  function C(t, e) {
    ...
    if (0 !== e) {
      ...
      if (
        1 <
        n /
          (t.spectrum.xVal[t.spectrum.xVal.length - 1] - e)
      )
        throw new Error(
  ...
  function j(t, f, o) {
    ...
    function O(i, o, s) {
      var t,
        ...
        n =
          (((t = {})[ot.PipsType.None] = ""),
          (t[ot.PipsType.NoValue] =
            f.cssClasses.valueNormal),
          (t[ot.PipsType.LargeValue] =
            f.cssClasses.valueLarge),
          (t[ot.PipsType.SmallValue] =
            f.cssClasses.valueSub),
          t),
        l =
          (((t = {})[ot.PipsType.None] = ""),
          (t[ot.PipsType.NoValue] =
            f.cssClasses.markerNormal),
          (t[ot.PipsType.LargeValue] =
            f.cssClasses.markerLarge),
          (t[ot.PipsType.SmallValue] =
            f.cssClasses.markerSub),
          t),
        u = [
          f.cssClasses.valueHorizontal,
          f.cssClasses.valueVertical,
        ],
        c = [
    ...
    function R(t, e) {
      if (
        ...
        return _(t, e);
      t =
        (f.dir ? -1 : 1) * (t.calcPoint - e.startCalcPoint);
      G(
        0 < t,
        (100 * t) / e.baseSize,
        e.locations,
    ...
    function B(t, e) {
      ...
      e.handleNumbers.some(k) ||
        ...
        t.cursor &&
          ((w.style.cursor = getComputedStyle(
            t.target
          ).cursor),
    ...
    function r(t) {
      ...
      !1 !== r &&
        (f.events.snap ||
          ut(d, f.cssClasses.tap, f.animationDuration),
        Q(r, e, !0, !0),
        K(),
        I("slide", r, !0),
        I("update", r, !0),
    ...
    ft((t = d), f.cssClasses.target),
      0 === f.dir
        ? ft(t, f.cssClasses.ltr)
        : ft(t, f.cssClasses.rtl),
      0 === f.ort
